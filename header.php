...
<head>
<script data-ad-client="ca-pub-4118987136087583" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header clear">
		<div class="header-row1" id="header-row">
			<div class="container">
				<div id="top-header">
					<div class="text-center">
					Welcome to Devstagram!
					</div>
					<ul id="social-links-top">
						<ul>
							<li><a href="#"><img src="<?php echo get_template_directory_uri() . '/assets/img/icon-facebook-white.png' ?>"></a></li>
							<li><a href="#"><img src="<?php echo get_template_directory_uri() . '/assets/img/icon-pinterest-white.png' ?>"></a></li>
							<li><a href="#"><img src="<?php echo get_template_directory_uri() . '/assets/img/icon-rss-white.png' ?>"></a></li> 
						</ul>
					</ul>
				</div> 
